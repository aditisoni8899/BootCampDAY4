...
<title>About Us - OUR-LIBRARY, New Delhi</title>
<A href="index.html"> <IMG SRC="images/library1.jpg"></IMG></A>
</head>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="100%"  border="0" cellspacing="10" cellpadding="0">
                    ...
                    <tr>
                      <td class="bodytext"><!-- InstanceBeginEditable name="Body of Article" -->
                              <p align="center" class="bodytextheading"><img id="no-border" src="images/library.jpg" width="165" height="208"><br>
                                <span class="style2">OUR-LIBRARY, c.p.</span></p>
  ...
  <table width="100%"  border="0" cellspacing="7" cellpadding="0">
        <tr>
          <td><div align="center"><span class="bottombar"><strong>&copy; OUR-LIBRARY, c.p., New Delhi. All Rights Reserved. </strong></span></div></td>
        </tr>
        <tr> 
          <td>
